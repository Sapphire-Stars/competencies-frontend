...
export class QuestionsAndAnswersComponent implements OnInit {
  ...
  onUpvoteQuestion() {
    ...
    this.service.voteQuestion(questionObj).subscribe(
      (data) => {
        console.log(data);
        this.response = data;
  ...
  onUpvoteAnswer(answer: any) {
    ...
    this.service.voteAnswer(questionAnswerObj).subscribe(
      (data) => {
  ...
  onDownvoteAnswer(answer: any) {
    ...
    this.service.voteAnswer(questionObj).subscribe(
      (data) => {
        console.log(data);
  ...
  onSubmit() {
    ...
    this.service
      .postAnswer(this.questionDetails[0].questionTitle, this.answerModel)
      .subscribe(
        (data) => {
          console.log(data);
